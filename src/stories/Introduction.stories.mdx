...
A component driven answer to inclusivity and usabillity of accesibillity.
...
The most important thing of accessibility is starting with the WCAG-guidlines and semantics. When using semantic HTML elements we can deliver extra context to screenreaders, making it less confusing to the user when used right.

<div class="button-container">
  <button class="next" onClick={linkTo('documentation-how-to-install--page')}>
    Next
